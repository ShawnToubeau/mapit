...
const btnBaseClass =
  "relative inline-flex items-center px-4 py-2 text-sm font-medium hover:bg-gray-50 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 w-full justify-center";
...
export default function NavigationFooter(props: NavigationFooterProps) {
  return (
    <span className="isolate inline-flex rounded-md border-t border-gray-300 shadow-sm">
      <button
        type="button"
