import { Icon, circle, type Circle, type LatLng } from "leaflet";
  ...
  return (
    <div>
      ...
      <Control prepend position="bottomright">
        <div className="map-control-border cursor-pointer rounded-full bg-white p-3 hover:bg-zinc-100 lg:rounded-md lg:p-1">
          <Image
