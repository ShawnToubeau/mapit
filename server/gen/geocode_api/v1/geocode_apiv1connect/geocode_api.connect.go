...
const (
	...
	GeocodeServiceName = "geocode_api.v1.GeocodeService"
)
...
func NewGeocodeServiceHandler(svc GeocodeServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/geocode_api.v1.GeocodeService/SearchAddress", connect_go.NewUnaryHandler(
		"/geocode_api.v1.GeocodeService/SearchAddress",
		svc.SearchAddress,
		opts...,
	))
	return "/geocode_api.v1.GeocodeService/", mux
}
