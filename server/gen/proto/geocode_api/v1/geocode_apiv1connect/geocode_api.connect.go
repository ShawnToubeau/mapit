...
import (
	...
	http "net/http"
	v1 "server/gen/proto/geocode_api/v1"
	strings "strings"
)
...
const (
	// GeocodeServiceName is the fully-qualified name of the GeocodeService service.
	GeocodeServiceName = "proto.geocode_api.v1.GeocodeService"
)

// GeocodeServiceClient is a client for the proto.geocode_api.v1.GeocodeService service.
...
// NewGeocodeServiceClient constructs a client for the proto.geocode_api.v1.GeocodeService service.
...
func NewGeocodeServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GeocodeServiceClient {
	...
	return &geocodeServiceClient{
		searchAddress: connect_go.NewClient[v1.SearchAddressRequest, v1.SearchAddressResponse](
			httpClient,
			baseURL+"/proto.geocode_api.v1.GeocodeService/SearchAddress",
			opts...,
		),
	}
}
...
// SearchAddress calls proto.geocode_api.v1.GeocodeService.SearchAddress.
...
// GeocodeServiceHandler is an implementation of the proto.geocode_api.v1.GeocodeService service.
...
func NewGeocodeServiceHandler(svc GeocodeServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	mux := http.NewServeMux()
	mux.Handle("/proto.geocode_api.v1.GeocodeService/SearchAddress", connect_go.NewUnaryHandler(
		"/proto.geocode_api.v1.GeocodeService/SearchAddress",
		svc.SearchAddress,
		opts...,
	))
	return "/proto.geocode_api.v1.GeocodeService/", mux
}
...
func (UnimplementedGeocodeServiceHandler) SearchAddress(context.Context, *connect_go.Request[v1.SearchAddressRequest]) (*connect_go.Response[v1.SearchAddressResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("proto.geocode_api.v1.GeocodeService.SearchAddress is not implemented"))
}
