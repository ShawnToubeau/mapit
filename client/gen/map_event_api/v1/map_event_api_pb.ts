...
// @generated from file map_event_api/v1/map_event_api.proto (package map_event_api.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message map_event_api.v1.CreateMapEventRequest
 */
export class CreateMapEventRequest extends Message<CreateMapEventRequest> {
  ...
  static readonly typeName = "map_event_api.v1.CreateMapEventRequest";
...
/**
 * @generated from message map_event_api.v1.CreateMapEventResponse
 */
export class CreateMapEventResponse extends Message<CreateMapEventResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.CreateMapEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message map_event_api.v1.GetMapEventRequest
 */
export class GetMapEventRequest extends Message<GetMapEventRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.GetMapEventRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message map_event_api.v1.GetMapEventResponse
 */
export class GetMapEventResponse extends Message<GetMapEventResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.GetMapEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message map_event_api.v1.GetAllMapEventsRequest
 */
export class GetAllMapEventsRequest extends Message<GetAllMapEventsRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.GetAllMapEventsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message map_event_api.v1.GetAllMapEventsResponse
 */
export class GetAllMapEventsResponse extends Message<GetAllMapEventsResponse> {
  /**
   * @generated from field: repeated map_event_api.v1.GetMapEventResponse events = 1;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.GetAllMapEventsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message map_event_api.v1.UpdateMapEventRequest
 */
export class UpdateMapEventRequest extends Message<UpdateMapEventRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.UpdateMapEventRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "start_time", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
...
/**
 * @generated from message map_event_api.v1.UpdateMapEventResponse
 */
export class UpdateMapEventResponse extends Message<UpdateMapEventResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.UpdateMapEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message map_event_api.v1.DeleteMapEventRequest
 */
export class DeleteMapEventRequest extends Message<DeleteMapEventRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.DeleteMapEventRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message map_event_api.v1.DeleteMapEventResponse
 */
export class DeleteMapEventResponse extends Message<DeleteMapEventResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "map_event_api.v1.DeleteMapEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
